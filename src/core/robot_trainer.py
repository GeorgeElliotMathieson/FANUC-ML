...
It implements a comprehensive approach to training robots for accurate end-effector
positioning using reinforcement learning with PPO.

The module offers convenient aliases and exports for clean integration with the
...
# Removed: import imageio  # For video recording if available
